...
function wasmComment(obj: any): string {
    return typeof obj.comment === "function" ? obj.comment() || "" : "";
}
...
export class StdLibDocObject {
    ...
    // Keep display categories stable while documentation is generated by the Rust environment builder.
    ...
    constructor(silex_funcs: any[], silex_const_funcs: any[]) {
        ...
        silex_funcs.forEach((f) => {
            ...
            doc_func.description = wasmComment(f) || `Add documentation.`;
...
export class FuncList {
    ...
    selected_version_el: HTMLElement;
    ...
    constructor(silex: any) {
        ...
        this.selected_version_el = document.getElementById('library_contract_version') as HTMLElement;
    ...
    reload(silex: any, reload: boolean = true) {
        ...
        this.selected_version_el.textContent = `V${silex.get_contract_version()}`;
        this.documentation_map = new StdLibDocObject(this.funcs, this.const_funcs);
        this.update_search_results(this.search_func_list.value);
    ...
    private update_search_results(search_value: string) {
        if (search_value === "") {
    ...
    handle_search_input(e: Event) {
        ...
        this.update_search_results(search_value);
        this.render_functions_ui();
    ...
    render_functions_ui() {
        ...
        function make_doc_table(syscall_id: number, gas_cost: number, description: string) {
            ...
            doc_desc.append(description_el);
