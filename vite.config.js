...
export default defineConfig(({ command }) => {
    ...
    // xelis_playground.js is glue code generated by ./xelis_wasm.sh
    // It is set as external in the bundler to avoid minification and worker function linking issues
    // The function below is to hash this specific file
    let xelis_playground_code_hash = ``;
    if (command === `build`) {
        const code = fs.readFileSync(`./public/xelis_playground.js`);
        const hasher = crypto.createHash(`sha256`);
        hasher.update(code);
        xelis_playground_code_hash = hasher.digest(`hex`).slice(0, 8);
    }
    ...
    const config = {
        ...
        build: {
            ...
            rollupOptions: {
                ...
                output: {
                    paths: (id) => {
                        if (id.includes(`/xelis_playground.js`)) {
                            return `/xelis_playground_${xelis_playground_code_hash}.js`;
                        }
                    },
                    manualChunks: (path) => {
        ...
        plugins: [
            ...
            }),
            {
                ...
                closeBundle: () => {
                    if (command === `build`) {
                        fs.renameSync(`./dist/xelis_playground.js`, `./dist/xelis_playground_${xelis_playground_code_hash}.js`);
                    }
                }
            }
        ],
