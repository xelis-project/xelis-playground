export class XelisXvmParser {
    parameter_builder_data = [];
    ...
    make_schema_from_entry(entry) {
        const _thisParser = this;

        let pb_obj = Object.create(null);

        pb_obj.id = entry.id();
        pb_obj.name = entry.name();
        ...
        _thisParser.parameter_builder_data.push(pb_obj);
