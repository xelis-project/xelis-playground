import {DataType, ParameterBuilder} from "../ParameterBuilder.js";

export function enum_type(parameter, root_container) {
    ...
    parameter.value.variants.forEach((variant, index) => {
